  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50/30 via-white to-amber-50/40">
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-2xl p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-green-100">Connect with members who are currently online</p>
              </div>
        ...
        {/* Online Status Info */}
        <div className="mb-6">
          <Card className="border-2 border-green-100/50 bg-green-50/50">
            <CardContent className="p-4">
              <div className="flex items-center space-x-2 text-green-700">
                <div className="h-3 w-3 bg-green-500 rounded-full animate-pulse"></div>
                <p className="text-sm font-medium">
                  These members are currently online and more likely to respond quickly to your messages!
                </p>
              </div>
            </CardContent>
          </Card>
